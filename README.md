  ...
  const approveAndPost = async () => {
    ...
    try {
      const payload = {
        ...
        // first 6 photos as data URLs — your Make/Zapier scenario hosts these and posts them
      ...
      setPostStatus("");
      setError(
        (e && e.message && e.message !== "delivery failed" ? e.message + " — " : "") +
  ...
  const generate = async () => {
    ...
    try {
      const details = Object.entries({
        ...
        Colour: form.colour, "Selling points": form.highlights,
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.ink, fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "20px 16px 80px" }}>
        ...
        <input style={{ ...FIELD_STYLE, marginTop: 10 }} placeholder="Colour" value={form.colour} onChange={set("colour")} />
        <textarea
          style={{ ...FIELD_STYLE, marginTop: 10, minHeight: 70, resize: "vertical", fontFamily: "inherit" }}
          placeholder="Selling points — full service history, 2 keys, new tyres, ULEZ compliant..."
